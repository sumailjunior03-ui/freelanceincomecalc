...
(function () {
  ...
  function renderFooter() {
    ...
    var partnershipsEmail = (window.FIC_CONFIG && window.FIC_CONFIG.site && window.FIC_CONFIG.site.email) ? window.FIC_CONFIG.site.email : 'partnerships@calc-hq.com';
    var siteName = (window.FIC_CONFIG && window.FIC_CONFIG.site && window.FIC_CONFIG.site.name) ? window.FIC_CONFIG.site.name : 'FreelanceIncomeCalc.com';
    ...
    footerTarget.innerHTML = [
      ...
      '<div class="container">',
        ...
        '</div>',
        '<p class="footer-meta">' + siteName + ' · Gross estimates only. No tax advice.</p>',
      '</div>',
      '</footer>'
    ].join('');
  }
